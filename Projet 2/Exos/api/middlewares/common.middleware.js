...
// Dans express, les middlewares qui ont 4 argument sont dédiés à la gestion des erreurs
// Ce middleware est directement appelé à par express quand on fait : next() avec en argument une erreur exemple : next(error)
// ici pour le paramètre err : j'attends soit une instance de la classe Error soit une instance de la classe HttpError 
